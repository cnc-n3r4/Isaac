...
class RestAPI:
    ...
    def _setup_routes(self):
        ...
        def create_bubble():
            ...
            return jsonify({"bubble_id": "new-bubble-id", "workspace_path": workspace_path}), 201
        ...
        def ai_query():
            ...
            return jsonify({"query_id": "query-id", "response": "AI response here"})
