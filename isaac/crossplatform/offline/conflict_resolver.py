...
class ConflictResolver:
    ...
    def detect_conflict(
        self, local_data: Dict[str, Any], remote_data: Dict[str, Any], resource_id: str
    ...
    def _resolve_manual(
        self, conflict: Dict[str, Any], manual_resolution: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
    ...
    def clear_resolved(self):
        ...
        self.pending_conflicts = [c for c in self.pending_conflicts if not c["resolved"]]
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {"total_conflicts": total, "pending": total - resolved, "resolved": resolved}
