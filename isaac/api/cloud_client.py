...
class CloudClient:
    ...
    def save_session_file(self, filename: str, data: dict) -> bool:
        ...
        try:
            ...
            payload = {"user_id": self.user_id, "filename": filename, "data": data}
    ...
    def get_session_file(self, filename: str) -> Optional[dict]:
        ...
        try:
            ...
            headers = {"Authorization": f"Bearer {self.api_key}"}
            params = {"user_id": self.user_id, "filename": filename}
    ...
    def route_command(self, device_alias: str, command: str) -> bool:
        ...
        try:
            ...
            payload = {"user_id": self.user_id, "target_device": device_alias, "command": command}
    ...
    def execute_cloud_meta(self, command: str) -> bool:
        ...
        try:
            ...
            payload = {"user_id": self.user_id, "command": command}
