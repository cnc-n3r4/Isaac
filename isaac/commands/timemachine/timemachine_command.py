...
class TimeMachineCommand:
    ...
    def _create_snapshot(self, args: List[str]) -> Dict[str, Any]:
        ...
        parser.add_argument(
            "-f", "--force", action="store_true", help="Force snapshot even if recent"
        )
        ...
        try:
            ...
            return {"success": False, "output": f"Failed to create snapshot: {e}", "exit_code": 1}
    ...
    def _show_timeline(self, args: List[str]) -> Dict[str, Any]:
        ...
        parser.add_argument(
            "-f",
            "--filter",
            choices=["all", "auto", "manual", "restore", "branch_switch"],
            default="all",
        ...
        try:
            ...
            if parsed.search:
                ...
                entries = [
                    e for e in entries if query_lower in f"{e.description} {e.change_type}".lower()
                ]

            if not entries:
                return {"success": True, "output": "No timeline entries found.", "exit_code": 0}
            ...
            return {"success": False, "output": f"Failed to show timeline: {e}", "exit_code": 1}
    ...
    def _restore_to_time(self, args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "output": f"Invalid time specification: {e}", "exit_code": 1}
    ...
    def _interactive_browse(self, args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "output": "Timeline browser closed.", "exit_code": 0}
        except Exception as e:
            return {
                "success": False,
    ...
    def _playback_mode(self, args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "output": "Playback completed.", "exit_code": 0}
        except Exception as e:
            return {"success": False, "output": f"Failed to start playback: {e}", "exit_code": 1}
    ...
    def _search_timeline(self, args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "output": f"Failed to search timeline: {e}", "exit_code": 1}
    ...
    def _show_stats(self, args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "output": f"Failed to get stats: {e}", "exit_code": 1}

    def _show_graph(self, args: List[str]) -> Dict[str, Any]:
        """Show timeline activity graph."""
        try:
            self.browser.show_timeline_graph()
            return {"success": True, "output": "Timeline graph displayed.", "exit_code": 0}
        except Exception as e:
            return {"success": False, "output": f"Failed to show graph: {e}", "exit_code": 1}
