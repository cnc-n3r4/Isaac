...
def main():
    ...
    try:
        ...
        if not sys.stdin.isatty():
            ...
            result = analyze_content(content, kind, analysis_type, stream_output=True)
...
def analyze_content(content: str, kind: str, analysis_type: str, stream_output: bool = False, use_spinner: bool = True) -> str:
