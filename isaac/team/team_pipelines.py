...
class TeamPipelineSharing:
    ...
    def share_pipeline(self, team_id: str, pipeline_data: Dict,
    ...
    def import_pipeline(self, team_id: str, pipeline_id: str,
                       pipeline_manager, user_id: str) -> Optional[str]:
    ...
    def update_pipeline(self, team_id: str, pipeline_id: str,
                       pipeline_data: Dict, updated_by: str) -> bool:
    ...
    def execute_pipeline(self, team_id: str, pipeline_id: str,
                        pipeline_runner, executed_by: str) -> Optional[Dict]:
    ...
    def get_pipeline_stats(self, team_id: str) -> Dict:
        ...
        stats['top_pipelines'] = sorted(
            pipelines,
            key=lambda p: p.get('execution_count', 0),
            reverse=True
        )[:10]
