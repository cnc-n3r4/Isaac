...
class SearchReplaceTool(BaseTool):
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Error in search/replace: {e}"}
...
class WriteTool(BaseTool):
    ...
    def get_parameters_schema(self) -> Dict[str, Any]:
        return {
            "type": "object",
            "properties": {
                "file_path": {"type": "string", "description": "Path to file to create"},
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Cannot create parent directories: {e}"}
        ...
        try:
            ...
            return {"success": True, "file_path": str(path), "bytes_written": bytes_written}
        except Exception as e:
