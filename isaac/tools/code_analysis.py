...
class CodeAnalysisTool(BaseTool):
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            if language == 'python':
                ...
                analysis = self._analyze_javascript(content, analysis_type, include_private, max_depth)
            else:
                return {
                    'success': False,
            ...
            return {
                'success': False,
                'error': f'Error analyzing code: {e}'
            }
    ...
    def _analyze_python(self, content: str, analysis_type: str, include_private: bool, max_depth: int) -> Dict[str, Any]:
    ...
    def _analyze_javascript(self, content: str, analysis_type: str, include_private: bool, max_depth: int) -> Dict[str, Any]:
