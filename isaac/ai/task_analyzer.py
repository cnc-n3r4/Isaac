...
class TaskAnalyzer:
    ...
    PROVIDER_CAPABILITIES = {
        ...
        'claude': {
            ...
            'strengths': [TaskType.CODE_WRITE, TaskType.CODE_DEBUG, TaskType.ANALYSIS,
                         TaskType.PLANNING, TaskType.TOOL_USE],
    ...
    def _detect_complexity(
        ...
        if re.search(r'\b(explain|describe|compare|contrast|difference between)\b', message, re.IGNORECASE):
    ...
    def compare_providers(
        ...
        for provider, info in self.PROVIDER_CAPABILITIES.items():
            ...
            avg_cost = (info['cost_per_1m_tokens']['input'] +
                       info['cost_per_1m_tokens']['output']) / 2
